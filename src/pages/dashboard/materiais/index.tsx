...
export default function Materiais() {
  ...
  const editingMat = useMemo(
    () => materiais.find((material) => material.id === editingMaterialbyID),
    [materiais, editingMaterialbyID]
  );
      ...
      >
        ...
        <form
          onSubmit={handleSubmit(
            editingMat ? handleUpdateMaterial : handleAddMaterial
          )}
        >
          <ModalContent>
            <ModalHeader>{`${
              editingMat ? "Editar" : "Adicionar novo"
